...
public class CraftingFakeInventory extends FakeInventory {
    @Getter
    @Setter
    private String name;

    public CraftingFakeInventory() {
        this(null);
    }

    public CraftingFakeInventory(InventoryHolder holder) {
        this(holder, null);
    }

    public CraftingFakeInventory(InventoryHolder holder, String title) {
        super(InventoryType.CHEST, holder, title);
    }

    CraftingFakeInventory(InventoryType type, InventoryHolder holder, String title) {
